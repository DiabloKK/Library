                        ...
                        <div class="card recent-sales overflow-auto">
                            ...
                            <div class="card-body">
                                    <div style="display: flex; align-items: center;">
                                        ...
                                        <div class="col-lg-2">
                                            <select id="Option" class="form-select" aria-label="Default select example" onchange = "getSelectedId()">
                                ...
                                <table class="table table-borderless datatable">
                                    ...
                                    <c:forEach var="borrowed" items="${borroweds}" varStatus="STT">
                                        <tr >
                                            ...
                                            <td><a href="UpdateBorrowed?id=${borrowed.id}" class="btn btn-success btn-comfirm"  data-bs-toggle="modal" data-bs-target="#comfirmModal">Xác nhận</a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                                <table class="table table-borderless datatable ">
                                    ...
                                    <c:forEach var="over" items="${overs}" varStatus="STT">
                                        <tr >
                                            ...
                                            <td><a href="UpdateBorrowed?id=${over.id}" class="btn btn-success btn-comfirm"  data-bs-toggle="modal" data-bs-target="#comfirmModal">Xác nhận</a></td>
...
<footer id="footer" class="footer">
    ...
    <!-- Modal -->
    <div class="modal fade" id="comfirmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
