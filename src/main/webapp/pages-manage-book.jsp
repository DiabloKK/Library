                    ...
                    <table class="table table-borderless table-striped datatable">
                        ...
                        <tr>
                            ...
                            <td><a
                                    ...
                                    class="btn btn-sm btn-success">Chỉnh sửa</a>
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary btn-danger" onclick="handleDelete(${book.getId()})"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal"
                                        style="padding-bottom: 5px; padding-top: 3px; font-size: 14px">Xóa
                                </button>
                            </td>
                        </tr>
                        </c:forEach>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <span class="text-danger"><p class="detail">Bạn có muốn chắc muốn xóa cuốn sách này không ? </p></span>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                    <a href="" id="deleteLink"><button type="button" class="btn btn-primary">Xoá</button></a>
                </div>
            </div>
        </div>
    </div>
