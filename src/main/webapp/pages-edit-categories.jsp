    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="ManageCategories">Manage Categories</a> </li>
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" method="post"
                              action="${pageContext.request.contextPath}/EditCategories">
                            ...
                            <div class="card-footer">
                                ...
                                <input type="button" value="Hủy" class="btn btn-primary"
                                       onclick="location.href='${pageContext.request.contextPath}/ManageCategories'">
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
